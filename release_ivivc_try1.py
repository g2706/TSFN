...
if __name__ == '__main__':
    ...
    OUTPUT_FIGURE_FILENAME = "correlation_nonlinear_fits_2_shot.png"
    # ================================================================
    ...
    ax.scatter(x_data, y_data, alpha=0.8, edgecolors='k', label='Release Point')
    ...
    ax.set_xlabel('In Vitro Predicted Release Value')
    ax.set_ylabel('In Vivo Experimental Release Values')
    ax.set_title('In Vitro-In Vivo Correlation (Pred vs. Exp)')
    ax.grid(True)
    ax.legend()
    plt.tight_layout()
